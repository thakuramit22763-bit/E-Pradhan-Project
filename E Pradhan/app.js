 ...
 * Department of Panchayati Raj, Government of Uttarakhand
 */
...
const i18n = {
  en: {
    ...
    deptSub: "Department of Panchayati Raj, Government of Uttarakhand / पंचायती राज विभाग, उत्तराखण्ड शासन",
    portalBadge: "OFFICIAL E-GOVERNANCE PORTAL",
    portalNotice: "Government of Uttarakhand • Directorate of Panchayati Raj • 24x7 Citizen Single Window Redressal System",
    navHome: "Home",
    ...
    secServicesTag: "E-Panchayat Service Delivery",
    secServicesTitle: "Popular Citizen Services (लोकप्रिय नागरिक ई-सेवाएँ)",
    secServicesSub: "Single-window online access to essential civic utilities, welfare schemes, revenue certificates, and public grievance desks.",
    ...
    step5: "05 Resolved",
    secCitizenTag: "Citizen Portal / नागरिक सेवा केंद्र",
    secCitizenTitle: "Citizen Self-Service Dashboard",
    secCitizenSub: "Manage your personal profile, track submitted grievances in real time, explore eligible schemes, and view official status updates.",
    secCharterTag: "Administrative Governance",
    secCharterTitle: "Panchayat Administrative Hierarchy & Citizen Charter",
    secCharterSub: "Department of Panchayati Raj, Government of Uttarakhand — Committed to transparent rural service delivery under Right to Public Service Act 2011.",
  ...
  hi: {
    ...
    deptSub: "पंचायती राज विभाग, उत्तराखण्ड शासन | Directorate of Panchayati Raj, Uttarakhand",
    portalBadge: "आधिकारिक ई-शासन पोर्टल",
    portalNotice: "उत्तराखण्ड शासन • पंचायती राज निदेशालय • 24x7 नागरिक एकल खिड़की समाधान प्रणाली",
    navHome: "मुख्य पृष्ठ",
    navServices: "नागरिक सेवाएँ",
    navSchemes: "सरकारी योजनाएँ",
    navGrievance: "शिकायत बॉक्स",
    navTrack: "स्थिति ट्रैक करें",
    navCitizen: "नागरिक पोर्टल",
    navAdmin: "एडमिन पैनल",
    navCharter: "नागरिक अधिकार पत्र",
    ...
    secServicesTag: "ई-पंचायत सेवा वितरण",
    secServicesTitle: "लोकप्रिय नागरिक ई-सेवाएँ (Popular Citizen Services)",
    secServicesSub: "नागरिक सुविधाओं, कल्याणकारी योजनाओं, राजस्व प्रमाण पत्रों एवं जन-शिकायत निवारण की एकल खिड़की ऑनलाइन पहुंच।",
    ...
    secCitizenTag: "नागरिक सेवा केंद्र",
    secCitizenTitle: "नागरिक स्व-सेवा डैशबोर्ड (Citizen Dashboard)",
    secCitizenSub: "अपनी प्रोफाइल प्रबंधित करें, दर्ज शिकायतों की रियल-टाइम स्थिति देखें, पात्र योजनाओं की जानकारी और विभागीय अपडेट प्राप्त करें।",
    secCharterTag: "प्रशासनिक सुशासन",
    secCharterTitle: "पंचायती राज प्रशासनिक ढांचा एवं नागरिक अधिकार पत्र",
    secCharterSub: "पंचायती राज विभाग, उत्तराखण्ड शासन — उत्तराखण्ड सेवा का अधिकार अधिनियम 2011 के तहत पारदर्शी जन-सेवा वितरण हेतु प्रतिबद्ध।",
    statusPending: "लंबित",
...
function showAcknowledgmentSlip(grievance) {
  ...
  slipContainer.innerHTML = `
    <div class="acknowledgment-slip printable-area">
      <div class="watermark">GOVT OF UTTARAKHAND</div>
      <div class="slip-header">
        <div style="display: flex; align-items: center; justify-content: center; gap: 14px; margin-bottom: 8px;">
          <span style="font-size: 2.2rem;">🏛️</span>
          <div>
            <h4 style="font-size: 1.3rem; color: #0b3b60; margin: 0; font-weight: 800;">E-PRADHAN SEVA CITIZEN PORTAL</h4>
            <p style="font-size: 0.85rem; color: #1e293b; font-weight: 700; margin-top: 2px;">Department of Panchayati Raj • Government of Uttarakhand</p>
            <p style="font-size: 0.78rem; color: #64748b;">Gram Panchayat Khatima, District Udham Singh Nagar</p>
          </div>
        </div>
        <div style="display: inline-block; background: #0b3b60; color: #fff; padding: 4px 18px; border-radius: 20px; font-size: 0.82rem; font-weight: bold; margin-top: 8px; letter-spacing: 0.5px;">
      ...
      <table class="slip-table">
        <tr>
          <td class="field-label">Complaint Token ID / शिकायत टोकन:</td>
          <td><strong style="color: #c62828; font-size: 1.2rem; letter-spacing: 0.8px; font-family: monospace;">${grievance.id}</strong></td>
        </tr>
        <tr>
          <td class="field-label">Registration Date & Time:</td>
          <td><strong>${grievance.createdAt}</strong></td>
        </tr>
        <tr>
          <td class="field-label">Citizen Name / नागरिक का नाम:</td>
          <td><strong>${grievance.citizenName}</strong> (Mobile: ${grievance.phone})</td>
        </tr>
        <tr>
          <td class="field-label">Gram Panchayat & Ward:</td>
          <td>${grievance.village}</td>
        </tr>
        <tr>
          <td class="field-label">Grievance Category / विभाग:</td>
          <td><strong>${grievance.categoryName}</strong></td>
        </tr>
        <tr>
          <td class="field-label">Priority Level / प्राथमिकता:</td>
        ...
        <tr>
          ...
          <td style="font-size: 0.85rem; color: #334155; line-height: 1.4;">${grievance.description}</td>
        </tr>
        <tr>
          <td class="field-label">Current Status / स्थिति:</td>
          <td><span class="status-pill status-pending">PENDING / समीक्षाधीन</span></td>
        </tr>
      </table>

      <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-top: 24px; border-top: 2px dashed #cbd5e1; padding-top: 16px; flex-wrap: wrap; gap: 14px;">
        <div style="font-size: 0.78rem; color: #475569; line-height: 1.5;">
          ✓ Keep this unique Complaint ID safe for tracking status online.<br>
          ✓ Track 24x7 at: <strong>https://epradhan.uk.gov.in/track</strong> or call CM Helpline <strong>1905</strong>.<br>
          ✓ Timebound resolution guaranteed under Uttarakhand Right to Public Service Act 2011.<br>
          ✓ Nodal Office: Gram Panchayat Khatima, Udham Singh Nagar (Uttarakhand).
        </div>
        <div style="display: flex; gap: 16px; align-items: center;">
          <div style="width: 80px; height: 80px; border: 1px solid #cbd5e1; background: #f8fafc; display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 0.65rem; color: #64748b; padding: 4px; text-align: center;">
            <span style="font-size: 1.5rem;">📱</span>
            <span>QR Digital Verification</span>
          </div>
          <div style="text-align: center;">
            <div style="width: 90px; height: 90px; border: 2px dashed #0b3b60; border-radius: 50%; display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 0.65rem; color: #0b3b60; margin: 0 auto; background: rgba(11, 59, 96, 0.04);">
              <span style="font-size: 1.2rem;">🏛️</span>
              <strong style="font-size: 0.65rem;">DIGITAL SEAL</strong>
              <span style="font-size: 0.58rem;">E-PRADHAN</span>
            </div>
            <span style="font-size: 0.72rem; color: #64748b; font-weight: 700; display: block; margin-top: 4px;">Nodal Officer Signatory</span>
          </div>
        </div>
      </div>
    </div>
...
function openAdminActionModal(complaintId) {
  ...
  document.getElementById('adminOfficerName').value = match.officerName === 'Officer Assigned Upon Review' ? 'Er. R. K. Sharma (Nodal Officer, E-Governance Cell, GP Khatima)' : match.officerName;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Start live clock for admin command center
  updateAdminLiveClock();
  setInterval(updateAdminLiveClock, 1000);
});

// --- CITIZEN DASHBOARD TAB WORKSPACE ---
function switchCitizenTab(tabKey) {
  const tabs = {
    grievances: { btn: 'tabBtnGrievances', pane: 'paneGrievances' },
    schemes: { btn: 'tabBtnSchemes', pane: 'paneSchemes' },
    locker: { btn: 'tabBtnLocker', pane: 'paneLocker' },
    notifications: { btn: 'tabBtnNotifs', pane: 'paneNotifs' }
  };
  ...
  if (tabs[tabKey]) {
    const targetBtn = document.getElementById(tabs[tabKey].btn);
    const targetPane = document.getElementById(tabs[tabKey].pane);
    if (targetBtn) targetBtn.classList.add('active');
    if (targetPane) targetPane.classList.add('active');
  }
}

// --- POPULAR CITIZEN SERVICES FILTER ---
function filterServices(category) {
  document.querySelectorAll('.srv-cat-btn').forEach(btn => {
    btn.classList.toggle('active', btn.dataset.srvcat === category);
  });
  ...
  document.querySelectorAll('.service-card').forEach(card => {
    if (category === 'all') {
      ...
      const cardCat = card.dataset.srvcat;
      card.style.display = (cardCat === category || cardCat === 'all') ? 'flex' : 'none';
    }
  });
}

// Quick pre-select grievance category & scroll
function quickSelectGrievanceCategory(catValue) {
  const select = document.getElementById('category');
  if (select) {
    select.value = catValue;
    showToast(`Category selected: ${select.options[select.selectedIndex]?.text || catValue}`, 'info');
  }
  navigateToSection('grievanceSection');
  const subjectInput = document.getElementById('subject');
  if (subjectInput) subjectInput.focus();
}

// Quick filter schemes
function quickFilterSchemes(category) {
  const catBtn = document.querySelector(`.cat-btn[data-cat="${category}"]`);
  if (catBtn) catBtn.click();
  navigateToSection('schemesSection');
}

// Open acknowledgment slip by token
function openAcknowledgmentByToken(token) {
  const grievances = getStoredGrievances();
  const found = grievances.find(g => g.id.toUpperCase() === token.toUpperCase());
  if (found) {
    showAcknowledgmentSlip(found);
  } else {
    showToast(`Slip for token ${token} not found.`, 'error');
  }
}

// Filter citizen table by status
function filterCitizenGrievanceTable(statusFilter) {
  const table = document.getElementById('citizenGrievanceTable');
  if (!table) return;
  ...
  rows.forEach(row => {
    if (statusFilter === 'all') {
      ...
      row.style.display = row.innerText.includes('Resolved') ? '' : 'none';
    } else if (statusFilter === 'Active') {
      row.style.display = (row.innerText.includes('In Progress') || row.innerText.includes('In Review') || row.innerText.includes('Pending')) ? '' : 'none';
    }
  });
}

// Filter admin table by status
function filterAdminTableByStatus(statusVal) {
  renderAdminGrievances(statusVal);
}
...
function exportAdminReportCSV() {
  ...
  if (!grievances.length) {
    showToast('No grievances to export.', 'info');
    return;
  }

  let csv = 'Token ID,Citizen Name,Phone,Gram Panchayat,Category,Priority,Subject,Status,Created At\n';
  grievances.forEach(g => {
    csv += `"${g.id}","${g.citizenName}","${g.phone}","${g.village}","${g.categoryName}","${g.priority}","${g.subject.replace(/"/g, '""')}","${g.status}","${g.createdAt}"\n`;
  });
  ...
  link.setAttribute('download', `E-Pradhan-Grievance-Audit-${new Date().toISOString().slice(0,10)}.csv`);
...
// Live clock for admin command center
